...
export default function DietPage() {
  ...
  return (
    <section className="section">
      ...
      <button 
        className="btn" 
        style={{ marginTop: '20px', background: showTips ? '#e74c3c' : '#27ae60' }} 
      ...
      {showTips && (
        <div style={{ marginTop: '15px', padding: '15px', background: '#e8f8f5', borderRadius: '8px' }}>
          <p>💡 <strong>Порада:</strong> Пийте мінімум 2 літри води на день та уникайте швидких вуглеводів після 18:00 для кращого результату.</p>
        </div>
      )}
    </section>
  );
